...
#define csv_debug_value(v) fprintf(stdout, #v " = \n"); csv_fprintf(v, stdout, CSV_DEBUG_FORMAT); fprintf(stdout, "\n\n"); // better to print to stderr if available
#define csv_debug_command(c) fprintf(stdout, ">> " #c "\n\n"); c;
